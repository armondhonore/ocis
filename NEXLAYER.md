...
**Live:** [https://relaxed-weasel-ocis.cloud.nexlayer.ai](https://relaxed-weasel-ocis.cloud.nexlayer.ai)  
...
**ocis** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
    - name: app
      image: "registry.nexlayer.io/user_01kece1xyh817dwff7wnarhkxd/ocis:9f0b5f0-fix8"
      path: /
      servicePorts:
        - 9200
      env:
